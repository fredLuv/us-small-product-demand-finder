...
const countryRows = [
  ...
  ["United Kingdom", "Tier 1 English", 80, "English", "High ecommerce maturity and strong DTC habit.", "Cards, PayPal, Apple Pay, Google Pay, Klarna/Clearpay, Open Banking", "Stripe; Shopify Payments; PayPal; Adyen; Checkout.com; Klarna", "Airwallex; Wise Business; Payoneer", "Stripe/Shopify + PayPal + Klarna/Clearpay", "VAT, product safety, return expectations.", "Medium", "Test after US if product has high AOV and clear value prop.", "S01; S02; S03; S04"],
  ["Australia / New Zealand", "Tier 2 English", 78, "English", "Good purchasing power; lightweight goods can absorb distance better.", "Cards, PayPal, Apple Pay, Google Pay, Afterpay, PayTo/PayID", "Stripe; Shopify Payments; PayPal; Adyen; Afterpay", "Airwallex; Wise Business; Payoneer", "Shopify/Stripe + PayPal + Afterpay", "Freight distance, GST, returns.", "Medium", "Use only for light, high-margin products.", "S01; S02; S03; S21"],
  ["Spain / EU", "Tier 1 Spanish + EU", 78, "Spanish", "Spanish-language market with EU purchasing power; compliance is heavier.", "Cards/debit, PayPal, Apple Pay, Google Pay, Bizum, SEPA, Klarna", "Stripe; Shopify Payments; PayPal; Adyen; Klarna; local PSPs", "Airwallex; Wise Business; Payoneer", "Stripe/Shopify + PayPal + Bizum/SEPA/Klarna where available", "VAT/IOSS, GPSR, EU returns, Spanish customer support.", "Medium-High", "Prepare EU compliance checklist before paid ads.", "S01; S02; S03; S04; S26; S27"],
  ...
  ["Germany / DACH", "Tier 2 EU", 74, "German", "Large EU ecommerce market with distinctive trust and payment preferences.", "PayPal, invoice/BNPL, SEPA, cards, Klarna", "Adyen; Stripe; PayPal; Klarna; Shopify Payments", "Airwallex; Wise Business; Payoneer", "PayPal + cards + SEPA/Klarna", "German language, return expectations, EU compliance.", "Medium-High", "Enter after EU compliance and support are ready.", "S01; S02; S03; S04; S26; S27"],
...
const sellerRows = [
  ...
  ["Seller payout stack", "Airwallex + Payoneer/WorldFirst/PingPong backup", "Multiple platforms and currencies", "Redundancy prevents one account review from stopping cash flow."],
...
write(dashboard, "A15:H18", [
  ...
  ["3", "Seller settlement", "Marketplace payouts, multi-currency accounts, FX, supplier payments.", "Example", "Airwallex, Payoneer, WorldFirst, PingPong, LianLian, Wise", "", "", ""],
